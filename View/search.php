...
<!-- Loading Screen -->
   ...
   for ($i = 0; $i < sizeof($tabcle); $i++) {
   	...
   	if ($tabcle[$i]<>'') {
			...
			$sm1=controller_ProdSimilaire1();
			$sm2=controller_ProdSimilaire2();
			$sm3=controller_ProdSimilaire3();
			$sm4=controller_ProdSimilaire4();
...
<a id="remove" onclick="" href="#" style="text-decoration: underline;margin-left: 75px;" class="deleteText">Supprimer</a>   
...
<script type="text/javascript">
	...
	$(document).on("click", "a.deleteText", function() {
		...
		<div class="close" onclick="recherche3('<?php if(isset($_POST['f1'])){ echo $_POST['f1']; } ?>','<?php if(isset($_POST['f2'])){ echo $_POST['f2']; }  ?>','<?php if(isset($_POST['f3'])){ echo $_POST['f3'];}  ?>','<?php if(isset($_POST['f4'])){ echo $_POST['f4']; } ?>','<?php if(isset($_POST['f5'])){ echo $_POST['f5']; } ?>',<?php if(isset($_POST['pg'])){ echo $_POST['pg']; }else{echo "1";} ?>);
		  recherche3('<?php if(isset($_POST['f1'])){ echo $_POST['f1']; } ?>','<?php if(isset($_POST['f2'])){ echo $_POST['f2']; }  ?>','<?php if(isset($_POST['f3'])){ echo $_POST['f3'];}  ?>','<?php if(isset($_POST['f4'])){ echo $_POST['f4']; } ?>','<?php if(isset($_POST['f5'])){ echo $_POST['f5']; } ?>',<?php if(isset($_POST['pg'])){ echo $_POST['pg']; }else{echo "1";} ?>);"></div>
